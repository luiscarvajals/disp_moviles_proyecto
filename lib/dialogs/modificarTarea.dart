...
import 'package:proyecto_final/models/tarea.dart';

dialogModificarTarea(BuildContext context, String id, String titulo, String materia, DateTime fechaLlega, String nota){
  ...
  Widget confirmButton = TextButton(
    ...
    onPressed: () {
      final doc = FirebaseFirestore.instance.collection('tareas').doc(id);
      doc.update({
